...
CREATE TABLE "UpdateDetail" (
    ...
    CONSTRAINT "UpdateDetail_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UpdateDetail" ADD CONSTRAINT "UpdateDetail_updateId_fkey" FOREIGN KEY ("updateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
